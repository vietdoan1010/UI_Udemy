...
const VideoCourse = ({ offset }) => {
  ...
  return (
    ...
    >
      <div
        className={`${
          pointScrollFixed ? "hidden" : ""
        } relative cursor-pointer`}
      >
        <div className="flex flex-col items-center justify-center absolute inset-0 bg-gradient-to-t from-[rgba(0,0,0,0.7)]">
          <div>
        ...
        <p className="absolute bottom-2 left-[28%] text-[16px] font-bold text-white">
          Preview this course
        </p>
        <img
      ...
      <div className="p-5">
        ...
        <Button
          className="text-[15px] font-bold bg-btnadd text-white mb-2"
          square="py-3"
          full
          borderNone
        >
        ...
        <div className="flex items-center justify-between text-sm font-bold opacity-90 mt-3">
          <p className="border border-transparent border-b-darkudemy">Share</p>
          <p className="border border-transparent border-b-darkudemy">
            Gift this course
          </p>
          <p className="border border-transparent border-b-darkudemy">
            Apply Coupon
