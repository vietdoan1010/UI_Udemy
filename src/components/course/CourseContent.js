  ...
  return (
    <section>
      ...
      <div className={`${topFlex} last:mb-2`}>
        ...
        <span className="text-contribute font-bold cursor-pointer hover:text-purple-700">
          Expand all section
        </span>
      </div>
          ...
          <div className="flex flex-col gap-4 p-5">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center justify-center bg-slate-200 rounded-full p-1 cursor-pointer">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
                    viewBox="0 0 24 24"
      ...
      <div className="border border-slate-200">
        <div className="flex items-center justify-between w-full bg-slate-100 border border-transparent border-b-slate-200 py-3 px-5 cursor-pointer">
          <div className="flex items-center gap-4">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
